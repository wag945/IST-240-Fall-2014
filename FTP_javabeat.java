//this class was downloaded from www.javabeat.net/file-upload-and-download-using-java
//and we discussed with Dr. Fred who approved it for using with downloading and uploading the .xml files
...
public class FTP_javabeat
{
   ...
   public void upload( String ftpServer, String user, String password,
         String fileName, InputStream source ) throws MalformedURLException,
         IOException
   {
   ...
   public void download( String ftpServer, String user, String password,
         String fileName, FileOutputStream destination ) throws MalformedURLException,
         IOException
   {
